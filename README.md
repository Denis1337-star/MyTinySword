...
- разработкой gameplay механик
- логикой поведения рабочих
- системой добычи ресурсов
- системой управления юнитами
- архитектурой игровых систем
- рефакторингом проекта
- настройкой NavMeshPlus
- настройкой Cinemachine
- созданием Tilemap карты
- настройкой Animator
