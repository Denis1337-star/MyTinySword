...
/// <summary>
/// ƒом Ч здание, которое владеет группой рабочих.
/// —оздаЄт стартовых рабочих, нанимает новых рабочих и хранит точки ожидани€/сдачи ресурсов.
/// </summary>
public sealed class House : BuildingBase
{
    ...
    public void HireWorker()
    {
        ...
        try
        {
            ...
            if (worker == null)
                Debug.LogError($"{name}: не удалось создать рабочего после списани€ ресурсов.", this);
        }
        finally
        {
