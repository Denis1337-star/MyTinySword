...
/// <summary>
/// Все UI-строки игры: RU/EN для динамических панелей и статичных подписей.
/// </summary>
public static class GameUiText
{
    ...
    public static string Ok => Lang.Pick("Понятно", "OK");
    ...
    public static bool TryGetStaticSceneEnglish(string russianText, out string englishText)
    {
        ...
        string key = russianText.Trim();
        return StaticSceneTextEn.TryGetValue(key, out englishText);
    }
}
