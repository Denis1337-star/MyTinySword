...
public class BuildingBase : ValidatedMonoBehaviour
{
    ...
    protected override bool ValidateInternal()
    {
        ...
        valid &= ValidationUtility.Required(this, factionMember, nameof(factionMember));
        valid &= ValidationUtility.Required(this, health, nameof(health));
        valid &= ValidationUtility.Required(this, selectable, nameof(selectable));
